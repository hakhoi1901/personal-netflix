...
/**
 * Edit Movie Page — Fetches movie data by ID and renders the reusable MovieForm
 * in Edit mode. On submit, calls updateMovie and redirects.
 */
export default function AdminEditPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleUpdate = async (data: MovieFormData) => {
        setSubmitting(true);
        try {
            // Map form episodes to Episode type, preserving existing IDs where possible
